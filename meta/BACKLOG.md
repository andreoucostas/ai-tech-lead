...
**Astra value review:** `.claude/plans/2026-09-16-architecture-cdn-astra-review.md` records the
user-requested broader assessment. The HTML supplies browser-viewing convenience for the framework
