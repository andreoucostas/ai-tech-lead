...
> B-207 and B-134 are the bounded v0.79.1 delivery. After them, pursue B-42's independent field
> evidence as soon as a participant exists; its value is elapsed time and it should re-prioritize
> everything else. B-136 and B-174 are the next bounded implementation candidates. B-49 remains
...
**Status: IMPLEMENTED AND LOCALLY VERIFIED 2026-08-31 — immutable implementation review and exact
Windows/Linux candidate CI remain pending, so this entry stays open.** v0.79.1 takes only the
...
**Status: IMPLEMENTED AND LOCALLY VERIFIED 2026-08-31 — immutable implementation review and exact
Windows/Linux candidate CI remain pending, so this entry stays open.** The existing Git-for-Windows
...
**Status: IMPLEMENTED AND LOCALLY VERIFIED 2026-08-31 — immutable implementation review and exact
Windows/Linux candidate CI remain pending, so this entry stays open.** B-207's required native-5.1
...
failure. Completion still requires immutable review and exact-candidate Windows/Linux CI.
