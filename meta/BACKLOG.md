...
**Design:** `.claude/plans/2026-08-09-b125-warehouse-modelling-health-review-design.md` (rev 9;
initial implementation review `REJECT`, blocking findings incorporated, follow-up review pending)
