...
> **Frozen at v0.25.5 (2026-07-06)**, the point at which `ai-tech-lead-angular` merged into the
> single [`ai-tech-lead`](https://github.com/andreoucostas/ai-tech-lead) repo (B-25-EXEC,
> WSD-012). This file is preserved verbatim below as the Angular template's pre-merge history —
> it receives no further entries. New framework-level changes land in the root
> [`CHANGELOG.md`](../../CHANGELOG.md), which is now the single changelog for all three shipped
> distributions (dotnet, Angular, monorepo).
