...
Read `.github/instructions/framework-rules.instructions.md` for the framework workflow and
verification rules. This file contains the portable repository-specific context.
