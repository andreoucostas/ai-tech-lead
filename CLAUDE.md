...
- Auto-memory is disabled for this repo (`.claude/settings.json`). A decision goes to
...
- Maintainer skill: `/meta-gates <tier>`. It is a convenience; the commands `AGENTS.md` names are
  what is required.
