...
| Command | Purpose |
|---------|---------|
| `/bootstrap` | One-time: analyse the codebase (7 parallel passes A1–A7: modules, state, components, RxJS, API, build/test/quality, skill discovery), populate AGENTS.md + TECH_DEBT.md and write evidenced project skills under `.claude/skills` |
