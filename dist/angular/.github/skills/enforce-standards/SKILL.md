...
4. **Verify red**: confirm the gate bites — add a temporary `fdescribe` and an
   `// eslint-disable-next-line`, run that exact lint command, show both fail, revert. A gate you have not
