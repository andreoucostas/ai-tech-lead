...
Find and fix tech debt in a specific area of this repository. Derive applicable technologies and validation from repository evidence; do not infer Angular from this framework distribution. Read TECH_DEBT.md before starting (AGENTS.md is already loaded).
...
- Apply the fix
- Derive exact applicable **build**, **test**, **format**, **lint**, **migration/deploy**, and **data-validation** commands from `AGENTS.md`, committed CI, scripts, manifests, and configuration; run them after each fix and report every unsupported category as **not available**
