...
$ExpectedChecks=@('INDEX entry has no file','entry file has no INDEX line','malformed frontmatter','invalid type','INDEX entries are not sorted by slug','injection marker in INDEX line','injection marker in description','injection marker in body','wiki-check passed','invalid last-verified','verified entry cannot use last-verified: never')
...
@{n='malformed frontmatter fails';i=@('- [gotcha] [alpha](./alpha.md) — A useful fact');e=@{alpha="---`nname: alpha`nclaim"};x=1},
...
@{n='never last-verified passes for suspected entry';i=@('- [gotcha] [alpha](./alpha.md) — A useful fact');e=@{alpha=(Entry alpha 'A useful fact' gotcha suspected 'A factual claim.' 'never')};x=0},
@{n='never last-verified passes for unverified entry';i=@('- [gotcha] [alpha](./alpha.md) — A useful fact');e=@{alpha=(Entry alpha 'A useful fact' gotcha unverified 'A factual claim.' 'never')};x=0},
@{n='never last-verified fails for verified entry';i=@('- [gotcha] [alpha](./alpha.md) — A useful fact');e=@{alpha=(Entry alpha 'A useful fact' gotcha verified 'A factual claim.' 'never')};x=1},
