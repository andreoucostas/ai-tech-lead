...
// semantic `solid-check` agent. Scaffolded by the `enforce-architecture` skill. See the framework rules (`.github/instructions/framework-rules.instructions.md` › SOLID).
module.exports = {
  forbidden: [
    {
      name: 'no-circular',
