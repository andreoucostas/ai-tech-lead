...
Note their existence so the generated `CLAUDE.md` can reference them under the `.editorconfig & Analysers` (.NET) and `Angular Version & Tooling` (Angular) subsections. Do not merge their content.
