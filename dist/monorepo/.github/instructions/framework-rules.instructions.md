...
Apply Verification command discovery after each subtask; run only exact recorded invocations for changed technologies and fix failures before continuing.
