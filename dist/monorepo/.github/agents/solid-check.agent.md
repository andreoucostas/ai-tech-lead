...
- Use first-party project architecture and correctness evidence to assess each stack's injected-service seam; this framework does not require an interface, abstraction, or token.
