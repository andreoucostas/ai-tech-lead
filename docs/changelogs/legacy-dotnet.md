...
> **Frozen at v0.25.5 (2026-07-06)**, the point at which `ai-tech-lead-dotnet` merged into the
> single [`ai-tech-lead`](https://github.com/andreoucostas/ai-tech-lead) repo (B-25-EXEC,
> WSD-012). This file is preserved verbatim below as the .NET template's pre-merge history — it
> receives no further entries. New framework-level changes land in the root
