...
fails, repair only `.github/copilot-instructions.md`, `AGENTS.md`, or the `.github/skills/` mirror
generated by this workflow, then rerun. If a remaining failure is outside this workflow's scope,
