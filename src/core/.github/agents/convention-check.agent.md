...
description: Audits the current diff against AGENTS.md > Conventions and returns a structured findings table. Read-only. Use before opening a PR or as part of /review.
---
...
- If `AGENTS.md` is still unbootstrapped (`BOOTSTRAP_PENDING` marker present), abort with the single line defined in the canonical file.
