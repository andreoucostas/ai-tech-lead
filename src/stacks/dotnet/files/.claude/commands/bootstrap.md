---
description: "One-time framework setup: select evidenced technology profiles, analyse them, then populate framework-owned setup artifacts and report bounded repository-knowledge discovery. Developer-initiated only."
