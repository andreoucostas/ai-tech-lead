...
| Command | Purpose |
|---------|---------|
| `/bootstrap` | One-time: analyse selected .NET A1–A7 and/or warehouse-SQL W1–W3 profiles, plus one shared A8 skill-discovery pass, then populate AGENTS.md + TECH_DEBT.md and write evidenced project skills under `.claude/skills` |
