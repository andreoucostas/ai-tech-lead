...
<!-- GENERATED by /generate-copilot from AGENTS.md. Pre-/bootstrap: rules are conditional defaults, not repository facts; regenerate after /bootstrap populates evidenced Conventions. -->

## SOLID (both stacks)
- DIP: preserve each stack's evidenced project service boundary; do not introduce an interface, abstraction, token, or DI container from this summary alone.
