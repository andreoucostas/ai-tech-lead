...
- **GitHub Copilot CLI** — on CLI 1.0.80 (observed 2026-08-20), trusted-folder hooks run locally when the interpreter resolves; guard, type feedback, and mutable telemetry remain limited to their registered events.
