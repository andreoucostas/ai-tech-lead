...
$activePaths = @(
    ...
    'src/stacks/dotnet/snippets/AGENTS.md/enforce-skills', 'src/stacks/angular/snippets/AGENTS.md/enforce-skills', 'src/stacks/monorepo/snippets/AGENTS.md/enforce-skills',
